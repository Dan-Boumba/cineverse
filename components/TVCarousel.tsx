...
export default function TVCarousel({ title, shows, accentColor }: Props) {
  ...
  return (
    <section className="mb-10">
      <h2 className="text-white text-lg md:text-xl font-semibold mb-3 px-6 md:px-16 flex items-center gap-2">
        {accentColor && <span className="w-1 h-5 rounded-full inline-block" style={{ background: accentColor }} />}
        {title}
      </h2>
      <div className="relative group/carousel">
        ...
        <div ref={ref} className="flex gap-3 overflow-x-auto scrollbar-hide px-6 md:px-16 pb-2">
